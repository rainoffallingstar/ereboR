...
#'
#' @return methyratio
bam2methyratio = function(save2bismark = F,use_conda_env = NULL) {
    ...
    for (i in 1:length(bamfiles)) {
      ...
      command <- paste("python2", self$methyratio_py, "-I -o", output_dir_txt, "-d", self$gene_fa, paste0(self$root_dir,
        "/", bamfiles[i]))
